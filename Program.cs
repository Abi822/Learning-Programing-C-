    ...
    class Program
    {
        ...
        {           
            ...
            do
            {
                ...
                Console.WriteLine("\rType 1 for Task 1");
                Console.WriteLine("\rType 2 for Task 2");
                Console.WriteLine("\rType 3 for Task 3");
                Console.ResetColor();
                ...
                if (Task == 18) { BasicArrayOneFunctions(); break; }
                if (Task == 19) { BasicArrayTwoFunctions(); break; }
                if (Task == 20) { ArraykFunctions(); break; }
                if (Task == 21) { ArraykkFunctions(); break; }
                if (Task == 22) { ArraykkkFunctions(); break; }
                if (Task == 23) { TheArerageFunctions(); break; }
                if (Task == 24) { MethodsFunctions(); break; }
                if (Task == 25) { MethodskFunctions(); break; }
                if (Task == 26) { PiCalculatorFunctions(); break; }
                if (Task == 27) { MethodsBmiFunctions(); break; }
                if (Task == 100) { Colors(); break; }
                if (Task == 0) { Environment.Exit(0); }
                else if (Task >= 30 && Task != 100) { MenuElse(); Console.Clear(); }
        ...
        public static void BasicArrayOneFunctions()
        {
            //-----------------------Task 18------------------------\\
            ...
            Console.Write("Enter the name of the Gold Winner: ");
            winners[0] = Console.ReadLine();

            Console.Write("Enter the name of the Sliver Winner: ");
            winners[1] = Console.ReadLine();

            Console.Write("Enter the name of the Bronze Winner: ");
            winners[2] = Console.ReadLine();

            Console.Write("Who Place do you want to see: ");
            int imput = int.Parse(Console.ReadLine());

            Console.WriteLine("He came: {0}", winners[imput - 1]);
        ...
        public static void BasicArrayTwoFunctions()
        {
            //-----------------------Task 19------------------------\\
            ...
            string[] name = new string[5];
            {
                ...
                Console.Write("Enter the 3rd name: ");
                name[2] = Console.ReadLine();

                Console.Write("Enter the 4th name: ");
                name[3] = Console.ReadLine();

                Console.Write("Enter the 5th name: ");
                name[4] = Console.ReadLine();

                Console.WriteLine("The first name is: {0}", name[0]);
                Console.WriteLine("The last name is: {0}", name[4]);
        ...
        public static void ArraykFunctions()
        {
            //-----------------------Task 20------------------------\\
        ...
        public static void ArraykkFunctions()
        {
            //-----------------------Task 21------------------------\\
        ...
        public static void ArraykkkFunctions()
        {
            //-----------------------Task 22------------------------\\
        ...
        public static void ArraykkkkFunctions()
        {
            //-----------------------Task 23------------------------\\
        ...
        public static void MethodsFunctions()
        {
            ...
            Console.WriteLine("Your number is {0}", (CalculateForMethodsFunctions(num)));
        ...
        public static int CalculateForMethodsFunctions(int num)
        {
            return num *- 1;

        }
        public static void MethodskFunctions()
        {
            //-----------------------Task 25------------------------\\
            ...
            Console.Write("Enter Your Miles number: ");
            num = double.Parse(Console.ReadLine());
            Console.WriteLine("Your Kilometer number is: {0}", (CalculateMethod(num)));
        ...
        public static double CalculateMethod(double num)
        {
            double answer = num / 0.62137;
            return answer;
        }//(MethodsFunctions)\\
        public static void PiCalculatorFunctions()
        {
            //-----------------------Task 26------------------------\\
            ...
            Console.WriteLine("Your Radius {0} \nYour Circumference {1} \nYour Area {2}", radius, CircumferenceMethod(circumference), AreaMethod(area));
        ...
        public static double CircumferenceMethod(double circumference)
        {
            double pi = Math.PI;
            pi = circumference * 2;
            return circumference;
        }//(PiCalculatorFunctions)\\
        public static double AreaMethod(double area)
        {
            double piarea;
            piarea = area * Math.PI; 
            return area;
        }//(PiCalculatorFunctions)\\
        static void MethodsBmiFunctions()
        {
            //-----------------------Task 27------------------------\\
            ...
            Console.Write("Enter your hight in cm: ");
            num2 = Convert.ToDouble(Console.ReadLine()) / 100;

            double result = answer(num1, num2);

            Console.WriteLine(result);

            Console.WriteLine(bmicat(result));
        ...
        static double answer(double num1, double num2)
        {
        ...
        public static void TheArerageFunctions()
        {
            //-----------------------Task 28------------------------\\
            ...
            Console.WriteLine("The Arerage of those ten numbes is: {0}", num / 10);
